...
import { shadcnEditorStore } from '@/lib/utils'
...
export const EditorCommandOut: FC<EditorCommandOutProps> = ({
  ...
  const setQuery = useSetAtom(queryAtom, { store: shadcnEditorStore })
  const setRange = useSetAtom(rangeAtom, { store: shadcnEditorStore })
